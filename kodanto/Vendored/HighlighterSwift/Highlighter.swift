...
open class Highlighter {
    ...
    */
    ...
    public func setTheme(_ themeName: String, withFont: String? = nil, ofSize: CGFloat? = nil) -> Bool {
        ...
        guard let themePath = self.bundle.path(forResource: themeName, ofType: "css")
                ?? self.bundle.path(forResource: themeName, ofType: "css", inDirectory: "styles") else {
            return false
        }
    ...
    */
    public func availableThemes() -> [String] {
        ...
        let rootPaths = bundle.paths(forResourcesOfType: "css", inDirectory: nil)
        let stylePaths = bundle.paths(forResourcesOfType: "css", inDirectory: "styles")
        let paths = (rootPaths + stylePaths) as [NSString]
        var result = [String]()
        for path in paths {
